                        ...
                        <table class="w-full text-left">
                            <thead>
                                <tr class="border-b border-outline-variant">
                                    ...
                                    <th class="py-3 px-4 font-label-md text-on-surface-variant text-right">Physical</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-outline-variant/50 hover:bg-surface-container/50 transition-colors">
                                    ...
                                    <td class="py-3 px-4 font-body-md text-on-surface text-right font-semibold">{{ number_format($row['physical'], 2, ',', '.') }}</td>
